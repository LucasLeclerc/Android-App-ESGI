package com.example.pour_comprendre.ui.wishlist
...
class WishlistFragment : Fragment() {
    ...
    private val url = "http://141.94.245.122:3000/users/games_wishlist"
    private lateinit var progressBar: ProgressBar

    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View {
        val view: View = inflater.inflate(R.layout.fragment_wishlist, container, false)
        rvGames = view.findViewById(R.id.linear_game_wishlist)
        imageView = view.findViewById(R.id.no_wishlist)
        textView = view.findViewById(R.id.no_wishlist_text)
        progressBar = view.findViewById(R.id.progress_bar)

        this.apiCallWishlist()
